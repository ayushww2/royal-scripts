...
No I can’t truthfully. No no credible public record. No the documented story is.
No private thoughts written as medical fact. No courtroom scenes that did not happen.
Never tell the viewer the title cannot be confirmed.
...
function qualityIssues(script, title = "", targetWords = 3500) {
  ...
  if (isRefusal(text)) {
    issues.unshift("Do not refuse or fact-check the title. Write the title event as spoken narration.");
  }
